...
<p align="center">
 <img src="https://raw.githubusercontent.com/retroxd8-cmd/Gallium/main/Cyanide/Assets.xcassets/AppIcon.appiconset/icon-ios-1024x1024.png" alt="Gallium" width="160">
</p>

<h1 align="center">Gallium</h1>

**By [@retroxd8-cmd])** — an iOS tweak runner built on top of the DarkSword kernel r/w primitive.

Gallium is a fork of [`wh1te4ever/darksword-kexploit-fun`](https://github.com/wh1te4ever/darksword-kexploit-fun)
...
Open this page on your iPhone/iPad and tap one of the buttons below.
  ...
  <a href="https://github.com/retroxd-cmd/Gallium/releases/latest" target="_blank">
...
- [Report a bug](https://github.com/retroxd-cmd/Gallium/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/retroxd-cmd/Gallium/issues/new?template=feature_request.yml)
